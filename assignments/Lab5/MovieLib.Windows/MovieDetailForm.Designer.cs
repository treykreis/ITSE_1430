namespace MovieLib.Windows {
    partial class MovieDetailForm {
        ...
        private void InitializeComponent()
        {
			...
			this._txtLength.Validating += new System.ComponentModel.CancelEventHandler(this.ValidatingPrice);
			// 
			// _chkOwned
			// 
			...
			this.Validating += new System.ComponentModel.CancelEventHandler(this.ValidatingPrice);
